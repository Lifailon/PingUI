...
### headers treeview
headers = ["IP", "Status", "Time(ms)"]
table = TreeColor(frame, columns=headers, show="headings")
for header in headers:
    table.heading(header, text=header, anchor="center")
    table.column(header, anchor="center", minwidth=0, width=90)
